...
| `merchant` | `String?` | optional | Merchant name; future-proofs subscription detection |
...
- **Confirming** a draft creates a new `Transaction` (with `recurringTemplateId` set) and transitions the draft to `CONFIRMED`.
